...
public class EmployeeData {
    ...
    public static List<EmployeeCredential> getSampleEmployees() {
        ...
        employees.add(new EmployeeCredential("admin@example.com", "admin123", "admin123", "HR", 80000));
        employees.add(new EmployeeCredential("admin1@company.com", "admin1", "admin1", "HR", 55000));
        employees.add(new EmployeeCredential("manager1@company.com", "manager1", "manager1", "MANAGER", 60000));
        employees.add(new EmployeeCredential("supervisor1@company.com", "supervisor1", "supervisor1", "SUPERVISOR", 52000));
